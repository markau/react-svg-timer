...
class ReactSvgTimer extends React.Component {
	...
	componentDidMount() {
		...
		*/
		this.timerResetObservable = Observable.interval(10).subscribe(t => {
	...
	start() {
		...
		*/
		this.timerObservable = Observable.interval(1).subscribe(t => {
	...
	timerText() {
		...
		if (this.timerDuration < this.goalTimeMillis) {
			duration = moment.duration(
				buffer + this.goalTimeMillis - this.timerDuration
			);
		}
